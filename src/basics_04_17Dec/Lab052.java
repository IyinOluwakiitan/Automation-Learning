...
public class Lab052 {
    public static void main(String[] args) {
        //I am not able to debug this 17th dec video 1:50:30 Dec
...
//using step over would move it to the next line of code
//until you get to line of code that tallies with the score selected
//then you have true, it will print and give the grade in the console
//best practice is to add debug to condition only